<template>
    ...
    <main>
        ...
        <section class="journal-container">
            <span></span><h3 id="title">foodie Journal</h3><span></span>
        ...
        <!-- popular reciepes -->
        <section id="popular-reciepes">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-6">
                    <h3>Popular Reciepes</h3>
                    <h4 class="mb-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magni sequi ullam eaque porro illo facilis veritatis omnis, dolore architecto suscipit? </h4>
                    </div>
                </div>
                <div class="row">
                    ...
                    <article id="receipes-images" class="col-lg-6">   
                        <img src="../assets/images/Mixed-fruits-200x132.jpg" alt="">
                        <img src="../assets/images/r-rachel-park-366508-unsplash-min-200x132.jpg" alt="">
                        <img src="../assets/images/r-michelle-tsang-500721-unsplash-min-200x132.jpg" alt="">
        ...
        <!-- culinary collection -->
        <section id="culinary-collection">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-6">
...
<style lang="scss" scoped>
    ...
    .journal-container {
        ...
        span {
            ...
            border: 0.2px solid rgb(215, 215, 215);
        }
        #title {
